...
from .routers import auth, tickets, users, locations, recurring, reports, integration, settings, nfc, pools, bikes, bike_reservations, bike_maintenance, bike_admin, knowledge, notifications, messages, beta
...
async def lifespan(app: FastAPI):
    ...
    if BETA_MODE:
        logger.warning(
            "BETA-omgeving actief (v%s) — pushmeldingen, e-mail en HA-sensoren staan uit. "
            "Productiedatabase om te kopiëren: %s",
            app_version(),
            SOURCE_DB_PATH,
        )
