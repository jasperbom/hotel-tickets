...
# In beta-modus gaat er niets naar buiten: geen e-mail en (via ha_client) geen
# pushmeldingen. Testen mag het personeel niet wakker bellen.
SMTP_ENABLED = os.environ.get("SMTP_ENABLED", "false").lower() == "true" and not BETA_MODE
