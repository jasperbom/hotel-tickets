...
import { authApi, betaApi, loginBrandingApi, setSessionToken, type BetaStatus, type LoginBranding } from "../api/client";
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        {beta?.beta_mode && (
          <div className="mb-3 rounded-xl bg-amber-400 text-amber-950 px-4 py-2 text-center text-xs font-semibold">
            <span className="uppercase tracking-wider">{beta.label}</span>
